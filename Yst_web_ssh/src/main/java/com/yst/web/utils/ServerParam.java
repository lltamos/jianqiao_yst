...
//			+ ":" + request.getServerPort() + path + "/";// 项目url
	...
	public static String IMAGE_UPLOAD_PATH =ServletActionContext.getServletContext().getRealPath("")+"/upload/";
	
	//项目绝对路径
	public static String ROOT_PATH=ServletActionContext.getServletContext().getRealPath("")+"\\";
	//html模板路径
