	...
	function sendMs() {
		...
		if (check()) {
			...
			$.ajax({
				type : 'POST',
				data : param,
				url : "customer!sendMessage.action",
				success : function(result) {
					...
					if (message != null) {
						...
						$("#sendMessage").text("发送错误，请检查手机号是否正确");
					} else {
						$("#sendMessage").text("发送成功请输入验证码");
					}
...
<body>
	...
	<form method="post" id="customerInfoForm">
		<table border="3" bordercolor="blue" width="60%" cellspacing="0"
			...
			<tr>
				<td>出生日期：</td>
				<td><input name="birth_day" type="text" /></td>
			</tr>
			<tr>
