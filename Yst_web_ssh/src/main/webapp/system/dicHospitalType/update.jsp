...
<script type="text/javascript">
	...
	function updateDoctor() {
		if (check()) {
			...
			var options = {
				url : 'dicHospitalType!updateAjax', //提交给哪个执行
				type : 'POST',
...
<body>
	<ul class="breadcrumb">
		...
		<li>医院类别列表 <span class="divider">/</span>
		</li>
		<li class="active">修改医院类别：</li>
	</ul>
	<form method="post" id="doctorInfoForm">
		<table border="3" bordercolor="blue" width="60%" cellspacing="0"
			...
			<tr>
				<td>名称：</td>
				<td>
					<input type="hidden" name="hospital_type_id" value="<s:property value="hospital_type_id" />"/>
			...
			<tr>
				<td colspan="2" align="center"><button class="btn"
					...
					<button class="btn" type="button"
						onclick="pageGo('dicHospitalType.action')">返回</button></td>
			</tr>
		</table>
