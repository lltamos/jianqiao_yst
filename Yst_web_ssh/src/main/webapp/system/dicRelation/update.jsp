...
<script type="text/javascript">
	...
	function updateDoctor() {
		if (check()) {
			...
			var options = {
				url : 'dicRelation!updateAjax', //提交给哪个执行
				type : 'POST',
	...
	<form method="post" id="doctorInfoForm">
		<table border="3" bordercolor="blue" width="60%" cellspacing="0"
			...
			<tr>
				<td>名称：</td>
				<td>
					<input type="hidden" name="relation_id" value="<s:property value="relation_id" />"/>
			...
			<tr>
				<td colspan="2" align="center"><button class="btn"
					...
					<button class="btn" type="button"
						onclick="pageGo('dicRelation.action')">返回</button></td>
			</tr>
		</table>
