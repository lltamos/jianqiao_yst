	...
	<form method="post" id="doctorInfoForm">
		<table border="3" bordercolor="blue" width="60%" cellspacing="0"
			...
			<tr>
				<td>名称：</td>
				<td>
					<input type="hidden" name="role_id" value="<s:property value="role_id" />"/>
					<input type="text" name="role_name" value="<s:property value="role_name" />" />
				</td>
			</tr>
			<tr>
				<td>说明：</td>
