...
<script type="text/javascript">
	...
	function updateDoctor() {
		if (check()) {
			...
			var options = {
				url : 'dicSpec!updateAjax', //提交给哪个执行
				type : 'POST',
	...
	<form method="post" id="doctorInfoForm">
		<table border="3" bordercolor="blue" width="60%" cellspacing="0"
			...
			<tr>
				<td>名称：</td>
				<td>
					<input type="hidden" name="spec_id" value="<s:property value="spec_id" />"/>
			...
			<tr>
				<td colspan="2" align="center"><button class="btn"
					...
					<button class="btn" type="button"
						onclick="pageGo('dicSpec.action')">返回</button></td>
			</tr>
		</table>
