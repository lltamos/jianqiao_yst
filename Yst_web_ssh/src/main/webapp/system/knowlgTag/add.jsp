...
<body>
	<ul class="breadcrumb">
		...
		<li>知识库标签列表 <span class="divider">/</span>
		</li>
		<li class="active">添加知识库标签：</li>
	</ul>
		...
		<table border="3" bordercolor="blue" width="60%" cellspacing="0"
			...
			<tr>
				<td colspan="2" align="center"><button class="btn"
						type="button" onclick="submitInfo()" id="save">确定</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="btn" type="button"
						onclick="pageGo('knowlgTag.action')">返回</button></td>
			</tr>
		</table>
