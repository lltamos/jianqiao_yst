...
<script type="text/javascript">
	...
	function saveActivity() {
		...
		if (check()) {
			...
			var options = {
				url : 'merchantActivity!addAjax', //提交给哪个执行
				type : 'POST',
		...
		<table border="3" bordercolor="blue" width="60%" cellspacing="0"
			...
			<tr>
				...
				<td><input type="text" name="begin_time" class="laydate-icon"
					id="start" style="width:200px; margin-right:10px;" /></td>
			</tr>
			<tr>
				<th>结束时间：</th>
				<td><input type="text" name="end_time" id="end"
					class="laydate-icon" style="width:200px; margin-right:10px;" /></td>
			</tr>
			<tr>
				<th>活动类型：</th>
				<td><select name="activity_type" id="activity_type"
					onchange="checkActivity_type()">
						<option value="1">商品促销</option>
						<option value="2">活动召集</option>
				</select></td>
			<tr id="type1">
				<th>促销商品：</th>
				<td><select name="prod_acti_id">
						<s:if test="#products.size()==0">
							<option value="">请先添加服务包</option>
						</s:if>
						<s:iterator value="#products">
							<option value="<s:property value="product_id"/>">
			...
			<tr id="type2">
				<th>图文详情：</th>
				<td><textarea name="content_desc" id="content_desc"></textarea></td>
			</tr>
			<tr>
