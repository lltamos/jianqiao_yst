...
<script type="text/javascript">
	...
	function savePatient() {
		if (check()) {
			...
			var options = {
				url : '${baseurl}/ydmvc/main/after/ajaxAddPatient.do', //提交给哪个执行
				type : 'POST',
...
<body>
	...
	<form class="form-horizontal" id="userInfoForm" method="post" enctype="multipart/form-data">
		...
		<div class="control-group">
			<label class="control-label" for="customer.customer_id">患者推荐人：</label>
			<div class="controls">
				<select class="customer" name="customer.customer_id" id="customer.customer_id" style="width: 350px;">
					<option value="">请选择</option>
					<c:forEach items="${customers}" var="revar">
						<option value="${revar['customer_id']}">
		...
		<div class="control-group">
			<label class="control-label" for="expertCustomer.customer_id">专家推荐人：</label>
			<div class="controls">
				<select class="expertCustomer" name="expertCustomer.customer_id" id="expertCustomer.customer_id" style="width: 350px;">
					<option value="">请选择</option>
					<c:forEach items="${customers}" var="revar">
						<option value="${revar['customer_id']}">
									手机号：${revar['phone']}，姓名：${revar['name']}</option>
