...
<script type="text/javascript">
				...
				.DataTable(
						{
							...
							"ajax" : {
								"url" : "${baseurl}/ydmvc/main/after/ajaxPatientList.do",
								"type" : "POST",
								"beforeSend" : function() {
									var data = this.data;
	...
	function view(id){
		pageGo("${baseurl}/ydmvc/main/after/viewPatientPage.do?id="+id);
	}
	function addOrder(id){
		pageGo("${baseurl}/ydmvc/main/after/addPatientOrderPage.do?patientId="+id);
	}
	function orderList(id){
		pageGo("${baseurl}/ydmvc/main/after/patientOrderPage.do?patientId="+id);
	}
</script>
<body>
	<ul class="breadcrumb">
	...
	<div class="btn-toolbar">
		<button class="btn" style="margin-right:60px; margin-left:20px;" onclick="pageGo('${baseurl}/ydmvc/main/after/addPatientPage.do')" type="button">添加患者信息
		</button>
	</div>
