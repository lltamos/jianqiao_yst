...
<script type="text/javascript">
							...
							"columns" : [
									...
									},
									{
										...
										"render" : function(data, type, full,
											...
											return "<button class='btn' type='button' title='查看详情' onclick='pageGo(\"product!showPage?product_id="
													+ data
													+ "\")'><i class='icon-eye-open'></i></button><button class='btn' type='button' title='编辑' onclick='pageGo(\"product!updatePage?product_id="
													+ data
	...
	function setIdToConfirmDialog(id,deleted) {
		...
		$confirmDeleteDialogBut.bind('click', function() {
			pageGo("product!disable?product_id="+ id+"&deleted="+deleted);
		});
	}
</script>
<body>
	...
	<div class="btn-toolbar">
		<button class="btn" style="margin-right:60px; margin-left:20px;" onclick="pageGo('product!addPage')"
	...
	<!-- dialog start -->
	<div class="modal hide fade" id="deleteModal" tabindex="-1"
