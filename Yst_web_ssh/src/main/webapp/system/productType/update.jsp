...
<script type="text/javascript">
	...
	function updateDoctor() {
		if (check()) {
			...
			var options = {
				url : 'productType!updateAjax', //提交给哪个执行
				type : 'POST',
...
<body>
	<ul class="breadcrumb">
		...
		<li>产品列表 <span class="divider">/</span>
		</li>
	...
	<form method="post" id="doctorInfoForm">
		<table border="3" bordercolor="blue" width="60%" cellspacing="0"
			...
			<tr>
				<td>名称：</td>
				<td>
					<input type="hidden" name="product_type_id" value="<s:property value="product_type_id" />"/>
			...
			<tr>
				<td colspan="2" align="center"><button class="btn"
					...
					<button class="btn" type="button"
						onclick="pageGo('productType.action')">返回</button></td>
			</tr>
		</table>
