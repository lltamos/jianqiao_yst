...
<body>
	...
	<form class="form-horizontal" id="resourceInfoForm" method="POST">
		...
		<table border="3" bordercolor="blue" width="40%" cellspacing="1"
			...
			<tr>
				...
				<select name="parent.menu_id" >
						<s:iterator value="#menus" >
							<option value="<s:property value="menu_id"/>"  >
			...
			<tr>
				<th>默认排序：</th>
				<td><input name="order_index" value="" type="text" /></td>
			</tr>
			<tr>
				<th>备注：</th>
				<td><input name="des" value="" type="text" /></td>
			</tr>
			<tr>
				<th>菜单序列号：</th>
				<td><input name="sn" value="" type="text" /></td>
			</tr>
			<tr>
