...
<script type="text/javascript">
				...
				.DataTable(
						{
							...
							"columns" : [
									...
									},
									{
										...
										"render" : function(data, type, full,
												meta) {
											return "<button class='btn' type='button' title='删除' onclick='setIdToConfirmDialog(\""
	...
	function setIdToConfirmDialog(id) {
		...
		$confirmDeleteDialogBut.bind('click', function() {
			pageGo("version!delete?version_id=" + id);
		});
	}
</script>
<body>
	...
	<div class="btn-toolbar">
		<button class="btn" onclick="pageGo('version!addPage')" type="button">上传新应用
		</button>
	</div>
