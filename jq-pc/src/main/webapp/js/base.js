...
//点击登录按钮(独立模式)
function independentModeLogin(str,str1) {
  /*  if ($("#login_account").val().length == 0) {
    ...
    loginInfo.identifier = str;
    loginInfo.userSig = str1;
  	/*loginInfo.identifier ="admin1";
	loginInfo.userSig = "*tTUtbCraUFW3dD430XC4uv35eacc7*DzUN*pdoWtFRehp0OrgMUXI7YnFrojFSVN92AMWOMIHS2n6Y7QOMGQRBmmIQI-UvQxnmoYDxU2oLDkzlAPaDlbcHFmgtHUx5GyYX6EpmA196e0qZW5dY27f3LewLHu4w8uZgvjqLebGNfilW23O8XKTV25mn1CElZRM85iXrG16JO81WSseLmHKbf5Djurz4d6pGIRrNJerBm5HOEY0rIfOJqt2s*nJe*b834jZ9fvuBXUw__"*/
