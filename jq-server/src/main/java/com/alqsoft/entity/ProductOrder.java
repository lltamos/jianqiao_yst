...
public class ProductOrder extends IdEntity implements Serializable {
	...
	private Integer payStatus; // 0 待支付定金 1已支付定金 2已支付全款 3确认一期款 4确认二期款 5确认三期款 6确认四期款 7确认五期款 8退一期款 9退二期款 10退三期款 11退四期款 12退五期款 13订单完成            
	                      
	private Integer payType;//支付类型 0支付宝 1银联 2京东 3微信
	...
	private Integer feePayStatus1;//0未支付 1已支付 2已确认 3分润完成 4退款中 5退款成功 6退款失败
	...
	private String patientName;//患者姓名快照
	private String patientPhone;//患者电话快照
	private String patientAddress;//患者地址
	private String recommPhone;//患者推荐人手机
	private String recommName;//患者推荐人姓名
	private String recommAddress;//患者推荐人地址
	private String merchantAddress;//总院地址
	private String merchantPhone;//总院电话
	private String merchantName;//总院名称
	private String productName;//服务包名称
	private String productRecommName;//项目推荐人名称
	private String productRecommPhone;//项目推荐人手机号
	private String customerName;//用户名称
	private String customerPhone;//用户手机号
	private String doctorPhone;//医生手机号

	private Long recommId;//患者推荐人ID
	private Long productRecommId;//项目推荐人ID
	...
	private Integer bookType=0;//是否发过日记 0未发 1已发
