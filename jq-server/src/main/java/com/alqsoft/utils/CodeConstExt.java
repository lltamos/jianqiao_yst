...
public class CodeConstExt {
	...
	public static final String PAY_SYSTEM_FROM_YDSHOP="PAY_SYSTEM_FROM_YDSHOP";//易定
	public static final String PAY_SYSTEM_FROM_BDSHOP="PAY_SYSTEM_FROM_BDSHOP";//本地
	public static final String PAY_SYSTEM_FROM_T="PAY_SYSTEM_FROM_T";//测试
	public static final String PAY_SYSTEM_FROM_BDBD="PAY_SYSTEM_FROM_BDBD";//本地报单
	public static final String PAY_SYSTEM_FROM_LT="PAY_SYSTEM_FROM_LT";//猎头
