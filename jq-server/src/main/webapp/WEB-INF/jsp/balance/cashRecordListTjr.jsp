				...
				.DataTable(
						{
							...
							"ajax" : {
								"url" : "${cxt}/balance/balancetjr-list",
								"type" : "POST",
								"cache":false,
								"beforeSend" : function() {
									var data = this.data;
...
<body>
	<ul class="breadcrumb">
	 ...
	 <%-- <div style="font-size: 20px;line-height: 50px;padding-left: 160px;">
		<span>分润总金额：${fenrun }元</span>
		<span style="padding-left: 70px;">可提现金额：${ketiixan}元</span>
		<span style="padding-left: 70px;">已提现金额：${yitixian}元</span>
	</div>  --%>
