...
<script type="text/javascript">
				...
				.DataTable(
						{
							...
							"ajax" : {
								"url" : "${ctx}/doctorserviceorder/doctorservice-list",
								"type" : "POST",
								"beforeSend" : function() {
									var data = this.data;
	...
	function queryInfo() {
		...
		var url = "${ctx}/doctorserviceorder/doctorservice-list?orderId=" +encodeURI(orderId)
...
<body>
	...
	<form class="form-horizontal" id="QForm" onSubmit="return false;">
			...
			<%-- <label style="margin-left:25px;display: inline-block;" for="doctorPhone">医生账号：</label>
			<input type="text" name="doctorPhone" id="doctorPhone" value="${doctorPhone }" /><br/> --%>
			<label style="margin-left:0px;display: inline-block;" for="serviceType">服务类型：</label>
			<select  style="width:148px;" id="serviceType" name="serviceType">
					<option ></option>
					<option value="1">在线咨询</option>
					<!-- <option value="2">在线预约</option> -->
			</select>
