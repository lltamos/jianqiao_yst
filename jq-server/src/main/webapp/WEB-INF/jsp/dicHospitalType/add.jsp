...
<script type="text/javascript">
	...
	function saveDoctorImage() {
		if (check()) {
			...
			var options = {
				url : '${ctx }/dic/hospital/hospital-add', //提交给哪个执行
				type : 'POST',
				success : function(result) {
					...
					if (success != "SUCCESS" ) {
						...
						pageGo('${ctx }/dic/hospital/to-hospital-list');
					}
				} //显示操作提示
			};
...
<body>
	<ul class="breadcrumb">
		...
		<li>医院类型列表 <span class="divider">/</span>
		</li>
		<li class="active">添加医院类型：</li>
	</ul>
			...
			<tr>
				<td colspan="2" align="center"><button class="btn"
					...
					<button class="btn" type="button"
						onclick="pageGo('${ctx }/dic/hospital/to-hospital-list')">返回</button></td>
			</tr>
		</table>
