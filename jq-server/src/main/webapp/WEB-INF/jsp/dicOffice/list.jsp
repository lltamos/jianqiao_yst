				...
				.DataTable(
						{
							...
							"ajax" : {
								"url" : "${ctx }/dic/office/office-list",
								"type" : "POST",
								"beforeSend" : function() {
									var data = this.data;
							...
							"columns" : [
									...
									},
									{
										...
										"render" : function(data, type, full,
											...
											var deleteStr = "";
											deleteStr = "<button class='btn' type='button' title='删除' onclick='pageGo(\"${ctx }/dic/office/office-delete?id="
													+ data
													+ "\")'><i class='icon-trash'></i></button>";
											return "<button class='btn' type='button' title='编辑' onclick='pageGo(\"${ctx }/dic/office/to-office-update?id="
													+ data
...
<body>
	...
	<div class="btn-toolbar">
		<button class="btn" onclick="pageGo('${ctx }/dic/office/to-office-add')" type="button">添加科室
		</button>
	</div>
