...
<script type="text/javascript">
	...
	function updateDoctor() {
		if (check()) {
			...
			var options = {
				url : '${ctx }/dic/office/office-add', //提交给哪个执行
				type : 'POST',
				success : function(result) {
					...
					if (success != "SUCCESS" ) {
						...
						pageGo('${ctx }/dic/office/to-office-list');
					}
				} //显示操作提示
			};
...
<body>
	<ul class="breadcrumb">
		...
		<li>关系科室 <span class="divider">/</span>
		</li>
			...
			<tr>
				<td colspan="2" align="center"><button class="btn"
					...
					<button class="btn" type="button"
						onclick="pageGo('${ctx }/dic/office/to-office-list')">返回</button></td>
			</tr>
		</table>
