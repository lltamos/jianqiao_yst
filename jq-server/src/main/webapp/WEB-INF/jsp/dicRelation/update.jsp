...
<script type="text/javascript">
	...
	function updateDoctor() {
		if (check()) {
			...
			var options = {
				url : '${ctx }/dic/relation/relation-add', //提交给哪个执行
				type : 'POST',
				success : function(result) {
					...
					if (success != "SUCCESS" ) {
						...
						pageGo('${ctx }/dic/relation/to-relation-list');
					}
				} //显示操作提示
			};
...
<body>
	<ul class="breadcrumb">
		...
		<li>关系列表 <span class="divider">/</span>
		</li>
		<li class="active">修改关系：</li>
	</ul>
		...
		<table border="1" width="60%" cellspacing="0"
			...
			<tr>
				...
				<td>
					...
					<input type="text" name="name" value="${relation.name }" />
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center"><button class="btn"
					...
					<button class="btn" type="button"
						onclick="pageGo('${ctx }/dic/relation/to-relation-list')">返回</button></td>
			</tr>
		</table>
