...
<script type="text/javascript">
	...
	function updateDoctor() {
		if (check()) {
			...
			var options = {
				url : '${ctx }/dic/title/title-add', //提交给哪个执行
				type : 'POST',
				success : function(result) {
					...
					if (success != "SUCCESS" ) {
						...
						pageGo('${ctx }/dic/title/to-title-list');
					}
				} //显示操作提示
			};
	...
	<form method="post" id="doctorInfoForm">
		<table border="1" width="60%" cellspacing="0"
			...
			<tr>
				...
				<td>描述：</td>
				<td>
					<input type="text" name="des" value="${title.des }" />
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center"><button class="btn"
					...
					<button class="btn" type="button"
						onclick="pageGo('${ctx }/dic/title/to-title-list')">返回</button></td>
			</tr>
		</table>
