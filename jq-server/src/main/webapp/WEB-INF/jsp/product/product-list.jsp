...
<script type="text/javascript">
				...
				.DataTable(
						{
							...
							"ajax" : {
								"url" : "${ctx}/product/product-list-data",
								"type" : "POST",
								"beforeSend" : function() {
									var data = this.data;
							...
							"columns" : [
									...
									},
									{
										...
										"render" : function(data, type, full,
											...
											return "<button class='btn' type='button' title='查看详情' onclick='pageGo(\"${ctx}/product/product-info?id="
													+ data
													+ "\")'><i class='icon-eye-open'></i></button><button class='btn' type='button' title='编辑' onclick='pageGo(\"${ctx}/product/product-input?id="
													+ data
	...
	function setIdToConfirmDialog(id,deleted) {
		...
		$confirmDeleteDialogBut.attr('onclick', "setIdToConfirm(this,'${ctx}/product/product-deleted?id="+ id+"&deleted="+deleted+"')");
	}
...
<body>
	...
	<div class="btn-toolbar">
		<button style="margin-right:60px; margin-left:25px;" class="btn" onclick="pageGo('${ctx}/product/product-input')"
			type="button">添加项目</button>
	</div>
