...
<script type="text/javascript">
				...
				.DataTable(
						{
							...
							"ajax" : {
								"url" : "${ctx}/sharemoney/recommender-list-data",
								"type" : "POST",
								"beforeSend" : function() {
									var data = this.data;
	...
	function cash() {
		pageGo("${cxt}/balance/goto-tjrcashreceive");
	}
</script>
<body>
	<ul class="breadcrumb">
	...
	<form class="form-horizontal" id="QFORM" name="QFORM" onsubmit="return false;">
			...
			<button class="btn" type="button" onclick="oTable.ajax.url('${ctx}/sharemoney/recommender-list-data?'+$('#QFORM').serialize()).load();">查询</button>
	</form>
